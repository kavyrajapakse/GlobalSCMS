...
<head>
    ...
    <title>Customs Compliance | GlobalTrade SCM</title>
...
<body>
    ...
    <header class="navbar">
        ...
        <nav class="nav-links">
            ...
            <a href="customs.jsp" id="link-customs" class="nav-link active" style="display: none;">Customs</a>
    ...
    <div class="container">
        <div class="page-header">
            <h1>Trade Compliance & Customs Declarations</h1>
            <p>Port clearance verification, tariff compliance, and international trade declarations.</p>
        </div>

        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-title">Pending Declarations</div>
                <div class="stat-value" style="color: var(--warning);">14</div>
                <div class="stat-sub">Under Verification</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Approved</div>
                <div class="stat-value" style="color: var(--success);">8,910</div>
                <div class="stat-sub">Port Cleared</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Rejected</div>
                <div class="stat-value" style="color: var(--danger);">0</div>
                <div class="stat-sub">100% Pass Rate</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Customs Holds</div>
                <div class="stat-value" style="color: var(--warning);">2</div>
                <div class="stat-sub">Document Check</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Compliance Alerts</div>
                <div class="stat-value" style="color: var(--brand-accent);">0</div>
                <div class="stat-sub">Zero Risk Flagged</div>
            </div>
        </div>

        <div class="panel">
            <h3>Port Declarations & Trade Clearance Log</h3>
            <p class="panel-desc">Official international port clearance manifests and tariff compliance filings.</p>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td><strong>CST-FIL-5501</strong></td>
                        <td>SCM-TRK-90812</td>
                        <td>Import Declaration for Rotterdam Sea Port</td>
    ...
    <script>
        ...
        // Access Control: Only ADMIN or CUSTOMS_AGENT can view customs.jsp
        if (!roles.includes('ADMIN') && !roles.includes('CUSTOMS_AGENT')) {
            alert('Access Denied: Your security role does not have access to Customs Operations.');
