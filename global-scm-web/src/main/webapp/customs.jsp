...
<head>
    ...
    <title>Customs Clearance & Port Authority | GlobalTrade SCM</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <div>
                <h1>Customs Clearance & Port Authority</h1>
                <p>Manage import/export customs declarations, manifest inspections, and port clearance approvals.</p>
            </div>
        ...
        <div class="sub-tabs">
            <button class="tab-btn active" onclick="switchTab('declarations-tab', this)">📑 Active Declarations & Filings</button>
            <button class="tab-btn" onclick="switchTab('alerts-tab', this)">🔔 Port Clearance Event Stream</button>
        </div>
        ...
        <div id="declarations-tab" class="tab-content active">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-sub">Cleared for Entry</div>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="font-size: 16px; color: var(--brand-accent); margin-top: 14px;">Hambantota Authority</div>
                    <div class="stat-sub">Primary Entry Port</div>
                </div>
            </div>
            ...
            <div class="top-row-cards">
                ...
                <div class="timer-card">
                    <div style="font-size: 12px; font-weight: 700; color: var(--brand-accent); text-transform: uppercase; margin-bottom: 6px;">⏱️ Automated Manifest Service</div>
                    <div style="font-size: 13px; color: var(--text-secondary);">Audit Frequency: <strong style="color: white;">Real-Time Stream</strong></div>
                    <div style="font-size: 13px; color: var(--text-secondary); margin-top: 2px;">Status: <span style="color: var(--success); font-weight: 700;">● Active Clearance Service</span></div>
                </div>
            </div>
        ...
        <div id="alerts-tab" class="tab-content">
            <div class="panel">
                <h3>🔔 Port Clearance & Inspection Stream</h3>
                <p class="panel-desc">Real-time customs clearance telemetry logged automatically.</p>
    ...
    <div id="file-modal" class="modal-backdrop">
        <div class="modal-card">
            ...
            <form id="file-declaration-form">
                ...
                <div class="form-group">
                    <label for="declaration-details">Customs Declaration Specification</label>
    ...
    <script>
                ...
                if (res.ok) {
                    ...
                    if (total === 0) {
                        ...
                        currentCustomsData.forEach(function(item) {
                            ...
                            var detailsStr = item.declarationDetails || 'Standard declaration filed.';
                            ...
                            tbody.innerHTML += '<tr>' +
                                ...
                                '<td>' +
                                    '<button class="btn-table-action" onclick="updateFilingStatus(' + item.id + ', \'APPROVED\')">✅ Approve</button>' +
                                    '<button class="btn-table-action" onclick="updateFilingStatus(' + item.id + ', \'CUSTOMS_HOLD\')">⚠️ Hold</button>' +
                                '</td>' +
                            '</tr>';
                        });
                    }
        ...
        window.addEventListener('load', loadCustomsFilings);
    </script>
</body>
</html>
